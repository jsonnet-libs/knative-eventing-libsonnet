{
  ...
  '#':: d.pkg(name='requestReply', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of RequestReply', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'eventing.knative.dev/v1alpha1',
    kind: 'RequestReply',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Spec defines the desired state of the RequestReply."'),
  spec: {
    '#brokerRef':: d.obj(help='"A KReference referring to the broker this RequestReply forwards events to. CrossNamespace references are not allowed."'),
    brokerRef: {
      '#withApiVersion':: d.fn(help='"API Version of the broker."', args=[d.arg(name='apiVersion', type=d.T.string)]),
      withApiVersion(apiVersion): { spec+: { brokerRef+: { apiVersion: apiVersion } } },
      '#withKind':: d.fn(help='"Kind of the broker. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { brokerRef+: { kind: kind } } },
      '#withName':: d.fn(help='"Name of the broker. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { brokerRef+: { name: name } } },
    },
    '#delivery':: d.obj(help='"Delivery contains the delivery spec for each trigger to this Broker. Each trigger delivery spec, if any, overrides this global delivery spec."'),
    delivery: {
    ...
    '#withCorrelationAttribute':: d.fn(help='"The name of the cloudevent attribute where the correlation id will be set on new events."', args=[d.arg(name='correlationAttribute', type=d.T.string)]),
    withCorrelationAttribute(correlationAttribute): { spec+: { correlationAttribute: correlationAttribute } },
    '#withReplyAttribute':: d.fn(help='"The name of the cloudevents attribute which will hold the correlation id for an event which will be treated as a reply."', args=[d.arg(name='replyAttribute', type=d.T.string)]),
    withReplyAttribute(replyAttribute): { spec+: { replyAttribute: replyAttribute } },
    '#withSecrets':: d.fn(help='"A list of the names of one or more secrets used to sign the correlation ids and reply ids. The secrets must be in the same namespace as the requestreply resource."', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecrets(secrets): { spec+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withSecretsMixin':: d.fn(help='"A list of the names of one or more secrets used to sign the correlation ids and reply ids. The secrets must be in the same namespace as the requestreply resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecretsMixin(secrets): { spec+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withTimeout':: d.fn(help='"A ISO8601 string representing how long RequestReply holds onto an incoming request before it times out without a reply."', args=[d.arg(name='timeout', type=d.T.string)]),
