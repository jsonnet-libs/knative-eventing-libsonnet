{
  ...
  spec: {
    ...
    subscribers: {
      '#auth':: d.obj(help='"Auth provides the relevant information for OIDC authentication."'),
      auth: {
        '#withServiceAccountName':: d.fn(help='"ServiceAccountName is the name of the generated service account used for this components OIDC authentication."', args=[d.arg(name='serviceAccountName', type=d.T.string)]),
        withServiceAccountName(serviceAccountName): { auth+: { serviceAccountName: serviceAccountName } },
        '#withServiceAccountNames':: d.fn(help='"ServiceAccountNames is the list of names of the generated service accounts used for this components OIDC authentication."', args=[d.arg(name='serviceAccountNames', type=d.T.array)]),
        withServiceAccountNames(serviceAccountNames): { auth+: { serviceAccountNames: if std.isArray(v=serviceAccountNames) then serviceAccountNames else [serviceAccountNames] } },
        '#withServiceAccountNamesMixin':: d.fn(help='"ServiceAccountNames is the list of names of the generated service accounts used for this components OIDC authentication."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAccountNames', type=d.T.array)]),
        withServiceAccountNamesMixin(serviceAccountNames): { auth+: { serviceAccountNames+: if std.isArray(v=serviceAccountNames) then serviceAccountNames else [serviceAccountNames] } },
      },
      ...
      '#withName':: d.fn(help='"The name of the subscription"', args=[d.arg(name='name', type=d.T.string)]),
