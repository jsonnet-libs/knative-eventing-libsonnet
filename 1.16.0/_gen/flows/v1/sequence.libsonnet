{
  ...
  '#':: d.pkg(name='sequence', url='', help='"Sequence defines a sequence of Subscribers that will be wired in series through Channels and Subscriptions."'),
  ...
  '#new':: d.fn(help='new returns an instance of Sequence', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'flows.knative.dev/v1',
    kind: 'Sequence',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Spec defines the desired state of the Sequence."'),
  spec: {
    ...
    '#reply':: d.obj(help='"Reply is a Reference to where the result of the last Subscriber gets sent to."'),
    reply: {
      ...
      '#withAudience':: d.fn(help="\"Audience is the OIDC audience of the reply. This only needs to be set if the target is not an Addressable and thus the Audience can't be received from the target itself. If specified, it takes precedence over the target's Audience.\"", args=[d.arg(name='audience', type=d.T.string)]),
      withAudience(audience): { spec+: { reply+: { audience: audience } } },
      '#withCaCerts':: d.fn(help='"Certification Authority (CA) certificates in PEM format that the source trusts when sending events to the reply."', args=[d.arg(name='caCerts', type=d.T.string)]),
    ...
    '#steps':: d.obj(help='"Steps is the list of Destinations (processors / functions) that will be called in the order provided. Each step has its own delivery options"'),
    steps: {
      ...
      '#withCaCerts':: d.fn(help='"Certification Authority (CA) certificates in PEM format that the source trusts when sending events to the sink."', args=[d.arg(name='caCerts', type=d.T.string)]),
      withCaCerts(caCerts): { caCerts: caCerts },
      '#withUri':: d.fn(help='"URI can be an absolute URL(non-empty scheme and non-empty host) pointing to the target or a relative URI. Relative URIs will be resolved using the base URI retrieved from Ref."', args=[d.arg(name='uri', type=d.T.string)]),
      withUri(uri): { uri: uri },
    },
    '#withSteps':: d.fn(help='"Steps is the list of Destinations (processors / functions) that will be called in the order provided. Each step has its own delivery options"', args=[d.arg(name='steps', type=d.T.array)]),
    withSteps(steps): { spec+: { steps: if std.isArray(v=steps) then steps else [steps] } },
    '#withStepsMixin':: d.fn(help='"Steps is the list of Destinations (processors / functions) that will be called in the order provided. Each step has its own delivery options"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='steps', type=d.T.array)]),
