{
  ...
  '#new':: d.fn(help='new returns an instance of SinkBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#subject':: d.obj(help='"Subject references the resource(s) whose \\"runtime contract\\" should be augmented by Binding implementations."'),
    subject: {
      '#selector':: d.obj(help='"Selector of the referents. Mutually exclusive with Name."'),
      selector: {
        ...
        withMatchExpressions(matchExpressions): { spec+: { subject+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { subject+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { subject+: { selector+: { matchLabels: matchLabels } } } },
        ...
        withMatchLabelsMixin(matchLabels): { spec+: { subject+: { selector+: { matchLabels+: matchLabels } } } },
      },
      '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
      withApiVersion(apiVersion): { spec+: { subject+: { apiVersion: apiVersion } } },
      '#withKind':: d.fn(help='"Kind of the referent."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { subject+: { kind: kind } } },
      '#withName':: d.fn(help='"Name of the referent. Mutually exclusive with Selector."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { subject+: { name: name } } },
      '#withNamespace':: d.fn(help='"Namespace of the referent."', args=[d.arg(name='namespace', type=d.T.string)]),
      withNamespace(namespace): { spec+: { subject+: { namespace: namespace } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
