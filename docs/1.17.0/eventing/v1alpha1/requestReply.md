---
permalink: /1.17.0/eventing/v1alpha1/requestReply/
---

# eventing.v1alpha1.requestReply
...
* [`obj spec`](#obj-spec)
  * [`fn withCorrelationAttribute(correlationAttribute)`](#fn-specwithcorrelationattribute)
  * [`fn withReplyAttribute(replyAttribute)`](#fn-specwithreplyattribute)
...
new returns an instance of RequestReply
...
### fn spec.withCorrelationAttribute

```ts
withCorrelationAttribute(correlationAttribute)
```

"The name of the cloudevent attribute where the correlation id will be set on new events."

### fn spec.withReplyAttribute

```ts
withReplyAttribute(replyAttribute)
```
