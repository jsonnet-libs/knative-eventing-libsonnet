---
permalink: /1.16.0/messaging/v1/channel/
---

# messaging.v1.channel
...
* [`obj spec`](#obj-spec)
  * [`fn withSubscribers(subscribers)`](#fn-specwithsubscribers)
  * [`fn withSubscribersMixin(subscribers)`](#fn-specwithsubscribersmixin)
  ...
  * [`obj spec.subscribers`](#obj-specsubscribers)
    * [`fn withGeneration(generation)`](#fn-specsubscriberswithgeneration)
    * [`fn withName(name)`](#fn-specsubscriberswithname)
    * [`fn withReplyAudience(replyAudience)`](#fn-specsubscriberswithreplyaudience)
    * [`fn withReplyCACerts(replyCACerts)`](#fn-specsubscriberswithreplycacerts)
    * [`fn withReplyUri(replyUri)`](#fn-specsubscriberswithreplyuri)
    * [`fn withSubscriberAudience(subscriberAudience)`](#fn-specsubscriberswithsubscriberaudience)
    * [`fn withSubscriberCACerts(subscriberCACerts)`](#fn-specsubscriberswithsubscribercacerts)
    * [`fn withSubscriberUri(subscriberUri)`](#fn-specsubscriberswithsubscriberuri)
    * [`fn withUid(uid)`](#fn-specsubscriberswithuid)
    * [`obj spec.subscribers.auth`](#obj-specsubscribersauth)
      * [`fn withServiceAccountName(serviceAccountName)`](#fn-specsubscribersauthwithserviceaccountname)
      * [`fn withServiceAccountNames(serviceAccountNames)`](#fn-specsubscribersauthwithserviceaccountnames)
      * [`fn withServiceAccountNamesMixin(serviceAccountNames)`](#fn-specsubscribersauthwithserviceaccountnamesmixin)
    * [`obj spec.subscribers.delivery`](#obj-specsubscribersdelivery)
      * [`fn withBackoffDelay(backoffDelay)`](#fn-specsubscribersdeliverywithbackoffdelay)
      * [`fn withBackoffPolicy(backoffPolicy)`](#fn-specsubscribersdeliverywithbackoffpolicy)
      * [`fn withRetry(retry)`](#fn-specsubscribersdeliverywithretry)
      * [`obj spec.subscribers.delivery.deadLetterSink`](#obj-specsubscribersdeliverydeadlettersink)
        * [`fn withUri(uri)`](#fn-specsubscribersdeliverydeadlettersinkwithuri)
        * [`obj spec.subscribers.delivery.deadLetterSink.ref`](#obj-specsubscribersdeliverydeadlettersinkref)
          * [`fn withApiVersion(apiVersion)`](#fn-specsubscribersdeliverydeadlettersinkrefwithapiversion)
          * [`fn withKind(kind)`](#fn-specsubscribersdeliverydeadlettersinkrefwithkind)
          * [`fn withName(name)`](#fn-specsubscribersdeliverydeadlettersinkrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specsubscribersdeliverydeadlettersinkrefwithnamespace)
...
## obj spec.subscribers

"This is the list of subscriptions for this subscribable."

### fn spec.subscribers.withGeneration
...
### fn spec.subscribers.withReplyAudience

```ts
withReplyAudience(replyAudience)
```

"ReplyAudience is the OIDC audience for the replyUri."

### fn spec.subscribers.withReplyCACerts

```ts
withReplyCACerts(replyCACerts)
```

"Certification Authority (CA) certificates in PEM format according to https://www.rfc-editor.org/rfc/rfc7468."

### fn spec.subscribers.withReplyUri

```ts
withReplyUri(replyUri)
```

"ReplyURI is the endpoint for the reply"

### fn spec.subscribers.withSubscriberAudience

```ts
withSubscriberAudience(subscriberAudience)
```

"SubscriberAudience is the OIDC audience for the subscriberUri."

### fn spec.subscribers.withSubscriberCACerts

```ts
withSubscriberCACerts(subscriberCACerts)
```

"Certification Authority (CA) certificates in PEM format according to https://www.rfc-editor.org/rfc/rfc7468."

### fn spec.subscribers.withSubscriberUri

```ts
withSubscriberUri(subscriberUri)
```

"SubscriberURI is the endpoint for the subscriber"

### fn spec.subscribers.withUid
...
## obj spec.subscribers.auth

"Auth provides the relevant information for OIDC authentication."

### fn spec.subscribers.auth.withServiceAccountName
...
### fn spec.subscribers.auth.withServiceAccountNames
...
### fn spec.subscribers.auth.withServiceAccountNamesMixin
...
## obj spec.subscribers.delivery

"DeliverySpec contains options controlling the event delivery"

### fn spec.subscribers.delivery.withBackoffDelay
...
### fn spec.subscribers.delivery.withBackoffPolicy
...
### fn spec.subscribers.delivery.withRetry
...
## obj spec.subscribers.delivery.deadLetterSink

"DeadLetterSink is the sink receiving event that could not be sent to a destination."

### fn spec.subscribers.delivery.deadLetterSink.withUri
...
## obj spec.subscribers.delivery.deadLetterSink.ref

"Ref points to an Addressable."

### fn spec.subscribers.delivery.deadLetterSink.ref.withApiVersion
...
### fn spec.subscribers.delivery.deadLetterSink.ref.withKind
...
### fn spec.subscribers.delivery.deadLetterSink.ref.withName
...
### fn spec.subscribers.delivery.deadLetterSink.ref.withNamespace
