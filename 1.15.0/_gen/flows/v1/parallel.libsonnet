{
  ...
  '#':: d.pkg(name='parallel', url='', help='"Parallel defines conditional branches that will be wired in series through Channels and Subscriptions."'),
  ...
  '#new':: d.fn(help='new returns an instance of Parallel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'flows.knative.dev/v1',
    kind: 'Parallel',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Spec defines the desired state of the Parallel."'),
  spec: {
    '#branches':: d.obj(help='"Branches is the list of Filter/Subscribers pairs."'),
    branches: {
      '#delivery':: d.obj(help='"Delivery is the delivery specification for events to the subscriber This includes things like retries, DLQ, etc."'),
      delivery: {
        ...
        deadLetterSink: {
          ...
          withAudience(audience): { delivery+: { deadLetterSink+: { audience: audience } } },
          ...
          withCaCerts(caCerts): { delivery+: { deadLetterSink+: { caCerts: caCerts } } },
      ...
      '#filter':: d.obj(help='"Filter is the expression guarding the branch"'),
      filter: {
        '#ref':: d.obj(help='"Ref points to an Addressable."'),
        ref: {
          '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
          withApiVersion(apiVersion): { filter+: { ref+: { apiVersion: apiVersion } } },
          '#withKind':: d.fn(help='"Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
          withKind(kind): { filter+: { ref+: { kind: kind } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { filter+: { ref+: { name: name } } },
          '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ This is optional field, it gets defaulted to the object holding it if left out."', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { filter+: { ref+: { namespace: namespace } } },
        },
        '#withAudience':: d.fn(help="\"Audience is the OIDC audience. This only needs to be set if the target is not an Addressable and thus the Audience can't be received from the target itself. If specified, it takes precedence over the target's Audience.\"", args=[d.arg(name='audience', type=d.T.string)]),
        withAudience(audience): { filter+: { audience: audience } },
        '#withCaCerts':: d.fn(help='"Certification Authority (CA) certificates in PEM format that the source trusts when sending events to the sink."', args=[d.arg(name='caCerts', type=d.T.string)]),
        withCaCerts(caCerts): { filter+: { caCerts: caCerts } },
        '#withUri':: d.fn(help='"URI can be an absolute URL(non-empty scheme and non-empty host) pointing to the target or a relative URI. Relative URIs will be resolved using the base URI retrieved from Ref."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { filter+: { uri: uri } },
      },
      '#reply':: d.obj(help='"Reply is a Reference to where the result of Subscriber of this case gets sent to. If not specified, sent the result to the Parallel Reply"'),
      reply: {
        '#ref':: d.obj(help='"Ref points to an Addressable."'),
        ref: {
          '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
          withApiVersion(apiVersion): { reply+: { ref+: { apiVersion: apiVersion } } },
          '#withKind':: d.fn(help='"Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
          withKind(kind): { reply+: { ref+: { kind: kind } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { reply+: { ref+: { name: name } } },
          '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ This is optional field, it gets defaulted to the object holding it if left out."', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { reply+: { ref+: { namespace: namespace } } },
        },
        '#withAudience':: d.fn(help="\"Audience is the OIDC audience. This only needs to be set if the target is not an Addressable and thus the Audience can't be received from the target itself. If specified, it takes precedence over the target's Audience.\"", args=[d.arg(name='audience', type=d.T.string)]),
        withAudience(audience): { reply+: { audience: audience } },
        '#withCaCerts':: d.fn(help='"Certification Authority (CA) certificates in PEM format that the source trusts when sending events to the sink."', args=[d.arg(name='caCerts', type=d.T.string)]),
        withCaCerts(caCerts): { reply+: { caCerts: caCerts } },
        '#withUri':: d.fn(help='"URI can be an absolute URL(non-empty scheme and non-empty host) pointing to the target or a relative URI. Relative URIs will be resolved using the base URI retrieved from Ref."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { reply+: { uri: uri } },
      },
      '#subscriber':: d.obj(help='"Subscriber receiving the event when the filter passes"'),
      subscriber: {
        '#ref':: d.obj(help='"Ref points to an Addressable."'),
        ref: {
          '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
          withApiVersion(apiVersion): { subscriber+: { ref+: { apiVersion: apiVersion } } },
          '#withKind':: d.fn(help='"Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
          withKind(kind): { subscriber+: { ref+: { kind: kind } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { subscriber+: { ref+: { name: name } } },
          '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ This is optional field, it gets defaulted to the object holding it if left out."', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { subscriber+: { ref+: { namespace: namespace } } },
        },
        '#withAudience':: d.fn(help="\"Audience is the OIDC audience. This only needs to be set if the target is not an Addressable and thus the Audience can't be received from the target itself. If specified, it takes precedence over the target's Audience.\"", args=[d.arg(name='audience', type=d.T.string)]),
        withAudience(audience): { subscriber+: { audience: audience } },
        '#withCaCerts':: d.fn(help='"Certification Authority (CA) certificates in PEM format that the source trusts when sending events to the sink."', args=[d.arg(name='caCerts', type=d.T.string)]),
        withCaCerts(caCerts): { subscriber+: { caCerts: caCerts } },
        '#withUri':: d.fn(help='"URI can be an absolute URL(non-empty scheme and non-empty host) pointing to the target or a relative URI. Relative URIs will be resolved using the base URI retrieved from Ref."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { subscriber+: { uri: uri } },
      },
    },
    '#channelTemplate':: d.obj(help='"ChannelTemplate specifies which Channel CRD to use. If left unspecified, it is set to the default Channel CRD for the namespace (or cluster, in case there are no defaults for the namespace)."'),
    channelTemplate: {
    ...
    '#reply':: d.obj(help='"Reply is a Reference to where the result of a case Subscriber gets sent to when the case does not have a Reply"'),
    reply: {
      '#ref':: d.obj(help='"Ref points to an Addressable."'),
      ref: {
        '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
        withApiVersion(apiVersion): { spec+: { reply+: { ref+: { apiVersion: apiVersion } } } },
        '#withKind':: d.fn(help='"Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
        withKind(kind): { spec+: { reply+: { ref+: { kind: kind } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { reply+: { ref+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ This is optional field, it gets defaulted to the object holding it if left out."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { reply+: { ref+: { namespace: namespace } } } },
      },
      '#withAudience':: d.fn(help="\"Audience is the OIDC audience. This only needs to be set if the target is not an Addressable and thus the Audience can't be received from the target itself. If specified, it takes precedence over the target's Audience.\"", args=[d.arg(name='audience', type=d.T.string)]),
      withAudience(audience): { spec+: { reply+: { audience: audience } } },
      '#withCaCerts':: d.fn(help='"Certification Authority (CA) certificates in PEM format that the source trusts when sending events to the sink."', args=[d.arg(name='caCerts', type=d.T.string)]),
      withCaCerts(caCerts): { spec+: { reply+: { caCerts: caCerts } } },
      '#withUri':: d.fn(help='"URI can be an absolute URL(non-empty scheme and non-empty host) pointing to the target or a relative URI. Relative URIs will be resolved using the base URI retrieved from Ref."', args=[d.arg(name='uri', type=d.T.string)]),
      withUri(uri): { spec+: { reply+: { uri: uri } } },
    },
    '#withBranches':: d.fn(help='"Branches is the list of Filter/Subscribers pairs."', args=[d.arg(name='branches', type=d.T.array)]),
    withBranches(branches): { spec+: { branches: if std.isArray(v=branches) then branches else [branches] } },
    '#withBranchesMixin':: d.fn(help='"Branches is the list of Filter/Subscribers pairs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='branches', type=d.T.array)]),
    withBranchesMixin(branches): { spec+: { branches+: if std.isArray(v=branches) then branches else [branches] } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
